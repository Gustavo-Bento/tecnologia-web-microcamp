function adicao() {
    ...
    document.getElementById("confirmado-adicao").innerHTML = "Resultado ✔️"
}
function confirmado() {
...
function subtracao() {
    ...
    document.getElementById("confirmado-subtracao").innerHTML = "Resultado ✔️"
}
function divisao() {
    var x = 2
    var y = 2
    ...
    document.getElementById("confirmado-divisao").innerHTML = "Resultado ✔️"
}
function multiplicacao() {
    ...
    document.getElementById("confirmado-multiplicacao").innerHTML = "Resultado ✔️"
}